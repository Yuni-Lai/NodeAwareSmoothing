...
from reco_utils.dataset.split_utils import process_split_ratio,min_rating_filter_pandas,split_pandas_data_with_ratios
...
def split_by_user(data, col_user, user_num, algorithm,train_ratio):
    """
    ...
    if algorithm == 'sar':
        ...
        for i in tqdm(range(user_num)):
            ...
            train, test = python_stratified_split(user_temp, ratio=train_ratio, col_user='userID', col_item='itemID', seed=42)
